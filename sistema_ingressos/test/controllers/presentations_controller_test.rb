...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { date: @presentation.date, hour: @presentation.hour } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { date: @presentation.date, hour: @presentation.hour } }
